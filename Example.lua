...
local Window = Library.MakeWindow("Example","This is an example window.",false,true) 
--[[ Arguments: 
...
--]]
Window.OK.MouseButton1Click:Connect(function()
print("Pressed OK")
  end)
Window.Cancel.MouseButton1Click:Connect(function()
